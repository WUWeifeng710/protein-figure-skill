# ss_frosted_surface 模板渲染脚本参考（2.5.0 严格 API，已对 1AY7 出样图验证）
# cartoon 按二级结构上粉彩，surface 用同色（与 cartoon 呼应）+ 0.60 透（磨砂玻璃）
# 运行：在装有 PyMOL 2.5.0 + PyMOL-PUB 的环境里跑，例如 `conda run -n pymol_pub python ss_frosted_surface.py`
import os
